...
public enum MekanismLang implements ILangEntry {
    ...
    QIO_FLUIDS_DETAIL("qio", "fluids_detail"),
    QIO_GASES_DETAIL("qio", "gases_detail"),
    QIO_RESOURCES_DETAIL("qio", "resources_detail"),
    QIO_TYPES_DETAIL("qio", "types_detail"),
    QIO_DRIVE_TYPE_DETAIL("qio", "drive_type_detail"),
    QIO_DRIVE_STATUS_DETAIL("qio", "drive_status_detail"),
    QIO_ITEMS("qio", "items"),
    QIO_RESOURCES("qio", "resources"),
    QIO_TYPES("qio", "types"),
    QIO_TRIGGER_COUNT("qio", "trigger_count"),
    QIO_STORED_COUNT("qio", "stored_count"),
    QIO_UNLIMITED_COUNT_DRIVES("qio", "unlimited_count_drives"),
    QIO_UNLIMITED_TYPE_DRIVES("qio", "unlimited_type_drives"),
    ...
    UPGRADE_UNAVAILABLE("gui", "upgrade.unavailable"),
    UPGRADE_CONFLICTING("gui", "upgrade.conflicting"),
    ...
    BUTTON_OREDICT_FILTER("gui.oredict"),
    BUTTON_MATERIAL_FILTER("gui.material"),
