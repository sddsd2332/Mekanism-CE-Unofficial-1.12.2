...
public class GuiStamping extends GuiElectricMachine<StampingRecipe, TileEntityElectricMachine<StampingRecipe>> {
    ...
    protected IRecipeViewerRecipeType<?>[] getRecipeViewerRecipeTypes() {
        return new IRecipeViewerRecipeType[]{RecipeViewerRecipeType.STAMPING};
    }
}