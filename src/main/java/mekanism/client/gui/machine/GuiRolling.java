...
public class GuiRolling extends GuiElectricMachine<RollingRecipe, TileEntityElectricMachine<RollingRecipe>> {
    ...
    protected IRecipeViewerRecipeType<?>[] getRecipeViewerRecipeTypes() {
        return new IRecipeViewerRecipeType[]{RecipeViewerRecipeType.ROLLING};
    }
}