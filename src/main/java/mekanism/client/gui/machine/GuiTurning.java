...
public class GuiTurning extends GuiElectricMachine<TurningRecipe, TileEntityElectricMachine<TurningRecipe>> {
    ...
    protected IRecipeViewerRecipeType<?>[] getRecipeViewerRecipeTypes() {
        return new IRecipeViewerRecipeType[]{RecipeViewerRecipeType.TURNING};
    }
}